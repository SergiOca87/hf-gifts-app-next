    ...
    return (
        <ThemeLayout themeSettings={themeSettings}>
            <div className={`w-100 min-h-[calc(100svh-20rem)] flex justify-center items-center`}>
                <div className="mx-auto rounded-xl bg-[#ede7dc] shadow-md overflow-hidden">
                    <div class="bg-slate-900 p-6"></div>
                    <div class="px-8">
                        <div className="max-w-[60rem] mx-auto ">
                            ...
                            <div class="py-8 flex justify-between align-center mt-12 gap-8">
                                <h2 className="text-slate-700 text-2xl mt-10 mb-12 max-w-[30rem]">{event.data.attributes.intro_text}</h2>
                                <div >
